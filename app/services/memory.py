...
2. ФАКТЫ И ИМЕНА: Жестко фиксируй ЛЮБЫЕ новые имена, названия или концепции, упомянутые пользователем (даже если они кажутся странными или не из лора), чтобы персонаж мог на них опираться. Не удаляй старые факты, если они не опровергнуты.
...
async def maybe_generate_summary(
    ...
    summary_settings.max_tokens = 4096
